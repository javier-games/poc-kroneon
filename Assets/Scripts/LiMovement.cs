...
namespace Kroneon.Li{
	...
	public class LiMovement : MonoBehaviour
	{
		...
		public void Move(Vector3 move, bool crouch, bool jump){
			 ...
			 * 
			 *  Dont use move = Vector3.ProjectOnPlane(move, m_GroundNormal); it does not work.
			 * 
			 *  Abetter idea is to make operations with normals projected to de XZ Plane and normalized.
			 * 
			*/
		...
		void CheckGroundStatus(){
			...
			// Applying a 0.1f small offset in the origin to start the ray from inside the character (m_GroundCheckDistance should never be smaller or equal to 0.1f)
